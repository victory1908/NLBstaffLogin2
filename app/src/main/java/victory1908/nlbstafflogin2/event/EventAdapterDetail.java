 ...
 */
public class EventAdapterDetail extends RecyclerView.Adapter<EventAdapterDetail.ViewHolder> {

    private Context context;
    List <Event> events;

    public EventAdapterDetail(Context context, List<Event> events) {
    ...
    @Override
    public EventAdapterDetail.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        // Inflate the custom layout
        View eventView1 = inflater.inflate(R.layout.event_list_detail, parent, false);
    ...
    @Override
    public void onBindViewHolder(EventAdapterDetail.ViewHolder holder, int position) {
...
//            checkIn = (Button) itemView.findViewById(R.id.Check_in);
